...
delta = 0.005 
nonconformity_scores = calculate_nonconformity_score(Y_cal, Y_cal_hat) 
alpha_tilde = calculate_alpha_tilde_simplified_ACI(Y_cal, Y_cal_hat, nonconformity_scores, alpha, delta, 0.2)

print("Final adjusted significance level (alpha_tilde):", alpha_tilde)

# %%
prediction_intervals = prediction_interval(Y_test_hat, nonconformity_scores, alpha_tilde)
...
# %%
# Calculate the average length of prediction intervals
average_interval_length = calculate_average_interval_length(prediction_intervals)

print(f"Average Length of Prediction Intervals: {average_interval_length:.4f}")
